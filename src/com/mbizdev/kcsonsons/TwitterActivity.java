...
public class TwitterActivity extends Activity {
	...
	private String Subtitle = "Twitter";

	WebView browser;

	String urlTwitter = "https://mobile.twitter.com/KCandsonandsons/";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        { browser=(WebView) findViewById(R.id.webViewTwitter);
        browser.loadUrl(urlTwitter);
	  ...
	  */
	    ...
	    private boolean applyMenuChoice(MenuItem item)
	    {
	    	...
	    	{
	    	case 1:
	    		 i = new Intent(TwitterActivity.this, OpenHoursActivity.class); 	  
	 	        startActivity(i);
	    		break;
	    	case 2:
	    		 i = new Intent(TwitterActivity.this, PittaActivity.class); 	  
	  	        startActivity(i);    		
	  	        break;
	    	case 3:
	   		 	i = new Intent(TwitterActivity.this, MoreActivity.class); 	  
